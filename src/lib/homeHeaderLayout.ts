...
export const HEADER_COMPACT_BOTTOM_PADDING = 16;
...
export const REF_HEADER_COMPACT_ART_HEIGHT = 152;
export const REF_HEADER_COMPACT_HEIGHT =
  HEADER_TOP_PADDING +
  REF_HEADER_COMPACT_ART_HEIGHT +
